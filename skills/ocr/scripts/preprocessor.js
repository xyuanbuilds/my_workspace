...
export var PreprocessStrategy;
(function (PreprocessStrategy) {
    PreprocessStrategy["NONE"] = "none";
    PreprocessStrategy["GRAYSCALE"] = "grayscale";
    PreprocessStrategy["BINARIZE"] = "binarize";
    PreprocessStrategy["ENHANCE"] = "enhance";
    PreprocessStrategy["DENOISE"] = "denoise";
    PreprocessStrategy["AUTO"] = "auto";
...
export class ImagePreprocessor {
     ...
     */
    static applyBinarization(ctx, canvas, threshold = 128) {
        const imageData = ctx.getImageData(0, 0, canvas.width, canvas.height);
        const data = imageData.data;
     ...
     */
    static getBrowserImplementation() {
        return `
